          ...
          <div class="col-md-3 d-none d-md-block">
            <div class="item-2">
              <div class="post-media">
                <a href="<?php echo site_url();?>/vi/<?php echo $nameCatalog?>/<?php echo $child ->slug; ?>" title="<?php echo $child ->name; ?>">
                  <div class="table">
              ...
              <div class="post-content">
                <h3><a href="<?php echo site_url();?>/vi/<?php echo $nameCatalog?>/<?php echo $child ->slug; ?>" title="<?php echo $child ->name; ?>"><?php echo $child ->name; ?></a></h3>
              </div>
            </div>  
          </div>         
        <?php  } ?>
